...
public interface NbsRepository extends MongoRepository<Nbs, String> {
    ...
    @Query(value = "{}", fields = "{id: 1, title: 1, climateZone: 1, pilot: 1, mainImage: 1, geoLocation: 1, isUrBreathNbs: 1, keywords: 1}")
    Page<Nbs> findNbsBriefData(Pageable pageable);

    @Query(value = "{'climateZone': ?0}", fields = "{id: 1, title: 1, climateZone: 1, pilot: 1, mainImage: 1, geoLocation: 1, isUrBreathNbs: 1, keywords: 1}")
